...
function ITEM_USE.Use(player_state, item_id, instance_id, player, target_slot)
    ...
    if def.use and def.use.type == "repair_kit" then
        ...
        local target_id = nil
        if target_slot == "weapon" then
            target_id = equip.weapon_instance_id
        elseif target_slot == "armor_body" then
            target_id = equip.armor_body_instance_id
        elseif target_slot == "armor_head" then
            target_id = equip.armor_head_instance_id
        else
            target_id = equip.weapon_instance_id or equip.armor_body_instance_id or equip.armor_head_instance_id
        end
